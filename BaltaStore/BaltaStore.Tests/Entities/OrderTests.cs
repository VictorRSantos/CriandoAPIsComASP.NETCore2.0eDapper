...
namespace BaltaStore.Tests.Entities
{
    ...
    public class OrderTests
    {
        ...
        public OrderTests()
        {
            ...
            _customer = new Customer(name, document, email, "551441425");
        ...
        // Ao criar um novo pedido, o status deve ser create
        [TestMethod]
        public void StatusShouldBeCreateWhenOrderCreate()
        {
        ...
        // Dados mais 10 produtos, devem aver duas entregas
        [TestMethod]
        ...
        // Ao cancelar o pedido, o status dever cancelado
        [TestMethod]
